...
This concept differs from simple self-interest. A selfish agent may knowingly push for a better deal. A self-serving agent may sincerely believe that the better deal is also the fairer or more justified one. It also differs from [[Social preferences]], where utility depends directly on the welfare of others. Here the main issue is biased judgment about fairness or entitlement, not other-regarding utility itself. And it differs from [[Motivated reasoning]], which is the broader family of goal-sensitive reasoning of which self-serving bias may be one especially important subtype.
...
This concept matters because disputes often escalate not only when interests conflict, but when each side sincerely believes that its own position is more justified. That matters for law, labor negotiation, mediation, and organizational conflict. For policy and institutional design, the concept supports procedures that force perspective-taking, expose contrary evidence, or create neutral reference points before parties lock into self-favoring views.
...
How far should the current vault extend this concept beyond bargaining? When do self-serving judgments arise mainly from role-dependent information processing, and when from strategic posturing? Which debiasing tools work outside laboratory-style disputes?
