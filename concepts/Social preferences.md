...
[[Social preferences]] is the idea that people's utility depends not only on their own payoff, but also on the payoffs, treatment, or intentions of other people. In the current vault, the anchor sources are [[Jolls et al. 1998]], which gives an early behavioral-law-and-economics framing through fairness, acrimony, and scruples, [[Fehr and Schmidt 1999]], which gives the branch a formal model of inequity aversion, [[Rabin 1993]], which adds reciprocity and fairness-sensitive response to treatment by others, and [[DellaVigna 2009]], which reviews field evidence on giving, reciprocity, and workplace behavior. The older label bounded self-interest now lives inside this page as the earlier legal-policy vocabulary for the same broad motivational departure from narrow self-interest.

## Key distinctions

The concept differs from pure self-interest because it allows altruism, reciprocity, fairness concerns, or inequality aversion to enter utility directly. It also differs from interpersonal influence or conformity effects, where behavior changes because of social pressure or the influence of others rather than because the welfare of others enters utility. It further differs from [[Self-serving bias]], where the main issue is not what enters utility but how people interpret fairness or entitlement in ways that favor their own role. One of DellaVigna's main points is that social-preference models fit laboratory evidence well, but often travel less cleanly to the field than self-control or reference-dependence models.
...
The anchor sources are [[Jolls et al. 1998]], [[Fehr and Schmidt 1999]], [[Rabin 1993]], [[DellaVigna 2009]], [[Babcock and Loewenstein 2007 - Explaining the Bargaining Impasse - The Role of Self-Serving Biases (in Loewenstein 2007, ch. 8)]], and [[Laibson and List 2015]]. The closest neighboring pages are [[Self-serving bias]] and [[Nonstandard preferences]]. The broader topical home is [[Behavioral Economics]].
