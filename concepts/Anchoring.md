...
[[Ariely et al. 2003]] expands the debate by showing that anchors can influence willingness to pay for goods and experiences, creating not just biased estimates but stable-looking patterns of valuation. Later debates concern how universal the effect is and which mechanisms explain it best, but these sources now give the vault three levels of anchoring: the classic judgment pattern, the mechanistic refinement around adjustment, and the market-valuation extension into [[Coherent arbitrariness]].

## Practical or policy relevance

Anchoring matters for policy and institutions because people often react to initial prices, suggested ranges, default targets, prior budgets, or early public narratives. Those anchors can shape negotiations, expectations, and evaluations long after better information is available. The Epley-Gilovich branch adds a further implication: warnings and incentives will not reliably reduce all anchoring effects, because some anchors are tied to effortful adjustment and others are not. [[Ariely et al. 2003]] adds a stronger implication still: if anchors help construct apparent willingness to pay, then institutions that treat observed valuations as straightforward evidence of welfare may be leaning on unstable foundations. That makes anchoring relevant not only to judgment but also to markets, debiasing, welfare analysis, and public communication inside [[Behavioral Economics]].
...
What kinds of anchors are most powerful in real institutions rather than experiments? When can good process design reduce inappropriate anchoring without losing the practical value of useful starting points?
