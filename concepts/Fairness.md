...
The fifth distinction is between interpersonal fairness and algorithmic fairness. [[Statistical fairness criteria]] concerns formal criteria for machine predictions and classifications. That branch is related, but conceptually different: it asks how institutions should define fair algorithmic treatment, not how human fairness motives shape behavior.
...
This concept matters because institutions frequently rely on fairness perceptions even when they are not formally part of the incentive system. Wage setting, bargaining, legal compliance, taxation, redistribution, punishment, consumer relations, and public legitimacy all depend on whether people see outcomes and procedures as fair. It also matters because fairness can both support cooperation and generate conflict: shared fairness norms can stabilize institutions, but self-serving fairness interpretations can block agreement.
...
When should fairness be modeled as a stable social preference, and when as a context-sensitive judgment? How should economists distinguish altruism, inequity aversion, reciprocity, manners, and procedural justice in field settings? When do fairness concerns support institutional legitimacy, and when do self-serving fairness beliefs intensify conflict?
