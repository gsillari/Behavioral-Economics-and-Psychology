...
related_pages:
  ...
  - [[Kahneman and Tversky 1982 - Intuitive Prediction (in Kahneman et al. 1982, ch. 30)]]
  - [[Fischhoff 1982 - Debiasing (in Kahneman et al. 1982, ch. 31)]]
  - [[Nisbett et al. 1982 - Improving Inductive Inference (in Kahneman et al. 1982, ch. 32)]]
  - [[Debiasing]]
  - [[Arkes 1991]]
  - [[Soll et al. 2015]]
...
The concept differs from [[Prospect Theory]]. [[Heuristics and Biases]] is a program about judgment under uncertainty, inference, and the use of informal rules of thumb. [[Prospect Theory]] is a more specific descriptive theory of risky choice and valuation.
...
The representativeness branch is about judging probability, category membership, or causal plausibility by resemblance rather than by disciplined use of base rates or sampling logic. [[Kahneman and Tversky 1972]] gives an earlier focused statement of this mechanism as a basis for subjective probability judgment. In the current vault, that branch now has a clearer internal structure through [[Base-rate neglect]], [[Law of small numbers]], and [[Conjunction fallacy]]. [[Tversky and Kahneman 1983]] matters especially because it shows that the logic of representativeness can violate even elementary probability ordering. [[Kahneman and Frederick 2002]] later reframes part of this terrain through [[Attribute substitution]], which helps explain why difficult probabilistic questions are often answered through easier similarity-based ones.
...
[[Kahneman et al. 1982]] and later work broaden it into a larger family of inferential distortions.
...
The most important feature of the program is not that it studies human fallibility. Many traditions do that. What makes it distinctive is the combination of three things. First, it seeks recurrent mechanisms rather than isolated mistakes. Second, it evaluates those mechanisms against formal or quasi-formal benchmark norms. Third, it uses stylized experimental tasks to expose structure in judgment that ordinary introspection would miss.

That is why the program matters so much to PPE. It is empirical psychology, but it is also a theory-laden intervention into debates about rationality. It asks not only how people judge, but how they ought to judge if they were reasoning in line with probability theory, statistics, or coherent updating.

## Later Reinterpretations

The original program did not remain intellectually stable. In the current vault, four later reinterpretive directions matter most.
...
But the page also matters because it keeps a caution visible. [[Hortal 2025]] is right to matter here: policy cannot use the heuristics-and-biases framework responsibly without recognizing it as one benchmark among competing accounts of rationality. The policy relevance of the program depends not only on whether the biases are real, but also on whether the benchmark used to identify them is the right one for the task at hand.

## Related pages

The best neighboring pages depend on what aspect of the program you want.

For the canonical mechanisms, start with [[Representativeness heuristic]], [[Availability heuristic]], and [[Anchoring]].
...
When should heuristic-driven judgment be treated as genuinely biased and when as context-sensitive or ecologically sensible? How much of the classic program survives later critique without losing its normative force? And how should the vault relate the original judgment-under-uncertainty program to its later descendants in dual-process theory, field evidence, policy design, and AI evaluation?
