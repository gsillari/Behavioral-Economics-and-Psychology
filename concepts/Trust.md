...
[[Trust]] is the willingness to make oneself vulnerable to another agent's choice under conditions where the other agent can reciprocate or exploit that vulnerability. In this wiki, trust belongs to the social-preferences and game-theory branch, not just to the risk branch.
...
This distinction prevents the trust branch from collapsing into [[Risk attitudes]]. A person may be willing to gamble but unwilling to trust, not because the payoff distribution differs, but because the social meaning differs.
...
When should trust be treated as a belief about another person's likely action, and when as a preference or norm? How much trust depends on social history and institutional background? Can trust be measured in a laboratory game without stripping away the very relationships that make it socially meaningful?
