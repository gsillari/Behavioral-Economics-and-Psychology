...
title: Dawes 1979
page_type: source
source_path: raw/papers/Dawes 1979.pdf
source_type: paper
status: ingested
tags:
...
For PPE students, [[Dawes 1979]] matters because it challenges the comfortable idea that expert discretion is automatically superior to simple formal procedures. It matters for economics because it raises questions about judgment quality, prediction, and model simplicity; for philosophy because it pushes on what should count as rational inference or justified expertise; and for politics because many institutions rely on professional judgment in admissions, sentencing, hiring, diagnosis, and public decision-making where transparent rules may outperform intuition.
...
One open question is how far the success of improper linear models depends on the structure of the environment rather than on general human limits. Another is whether these models should be interpreted as exposing irrationality, as vindicating simple heuristics, or both. A third is how the paper connects to current debates about algorithmic decision-making, transparency, and expert override.
