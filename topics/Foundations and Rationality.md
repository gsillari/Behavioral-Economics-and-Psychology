---
title: Foundations and Rationality
page_type: topic
status: active
tags:
  - topic
...
This first topic therefore begins with the strongest classical benchmarks and their limits. The point is not to dismiss those benchmarks. It is to see what they were trying to do, why they were attractive, and where later work in the vault begins to put them under pressure.

The first branch is decision-theoretic. [[von Neumann and Morgenstern 1944]] supplies the risk-side benchmark through [[Von Neumann-Morgenstern utility theory]], while [[Savage 1954]] supplies the uncertainty-side benchmark through [[Subjective expected utility theory]]. [[Heilmann and Reiss 2022]] helps organize the surrounding concepts of [[Utility theory]], risk, welfare, and preference.
...
The point of the full topic is cumulative: benchmarks first, limits second, rival frameworks third. The first branch establishes the classical decision-theoretic standards and their cracks. The second asks what new standards of rationality compete once those cracks appear. The third gives the cognitive architectures used to explain judgment. The fourth asks how behavioral economics becomes a field rather than a collection of isolated findings.
