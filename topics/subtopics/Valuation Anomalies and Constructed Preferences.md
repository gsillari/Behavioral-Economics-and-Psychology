---
title: Valuation Anomalies and Constructed Preferences
page_type: topic
status: active
tags:
  - topic
...
The topic page is still a structural stub so [[Choice, Preference, and Decision Under Risk]] can present its second-tier branches cleanly. But the branch is no longer centered only on later Ariely-style valuation results or on endowment-effect experiments. It is now organized more explicitly around the stronger claim that preferences can be response-mode-sensitive, context-shaped, and sometimes partly constituted in elicitation itself. A later drafting pass should explain how that program reshapes welfare interpretation, reveal-preference reasoning, and the legitimacy of policy built on elicited valuation.
