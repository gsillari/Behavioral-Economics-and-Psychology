---
title: Competing Views of Rationality
page_type: topic
status: active
tags:
  - topic
...
This topic gathers the main rival answers to the question of what rationality is once the classical benchmark stops looking self-evident. In the current vault, the core pages are [[Bounded rationality]], [[Rationality wars]], [[Ecological rationality]], [[Evolutionary psychology]], and [[Argumentative theory of reasoning]].

The point of this branch is not only that people depart from formal norms. It is that researchers disagree about which norms matter, when they matter, and whether one framework should dominate the whole field. In historical terms, [[Simon 1955]] is the starting point of this branch in the current vault, because it asks how rationality should be modeled for agents with finite information and finite computational capacity.
