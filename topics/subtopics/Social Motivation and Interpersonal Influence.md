...
This topic gathers the parts of the vault where behavior is shaped by fairness, altruism, reciprocity, trust, cooperation, self-serving interpretation, and interpersonal influence rather than by narrow self-interest alone. In the current vault, the key pages are [[Social preferences]], [[Fairness]], [[Trust]], [[Cooperation]], [[Reciprocity]], [[Self-serving bias]], and [[Motivated reasoning]], with [[Rabin 1998]] serving as the broad psychology-and-economics source for this social-motivation branch.
